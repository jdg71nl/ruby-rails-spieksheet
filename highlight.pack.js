...
contains:r.concat(g).concat(d)}}}());hljs.registerLanguage("erb",function(){"use strict";return function(e){return{
name:"ERB",subLanguage:"xml",contains:[e.COMMENT("<%#","%>"),{begin:"<%[%=-]?",
end:"[%-]?%>",subLanguage:"ruby",excludeBegin:!0,excludeEnd:!0}]}}}());hljs.registerLanguage("go",function(){"use strict";return function(e){var n={
...
name:"JSON",contains:t,keywords:e,illegal:"\\S"}}}());hljs.registerLanguage("php",function(){"use strict";return function(e){var r={
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}}());hljs.registerLanguage("yaml",function(){"use strict";return function(e){
